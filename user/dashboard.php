					...
					<ul class="nav">
						...
						<li>
							<a href="#subPages" data-toggle="collapse" class="collapsed"><i class="lnr lnr-file-empty"></i> 
								<span>Daftar Pesanan</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="pesanmakanan.php" class="">Pemesanan Makanan</a></li>
									<li><a href="pesantabung.php" class="">Pemesanan Tabung</a></li>
								</ul>
							</div>
						</li>
					</ul>
